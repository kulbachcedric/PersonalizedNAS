...
class HyperParameterType(Enum):
    ...
    @staticmethod
    def from_str(label):
        if 'HyperParameterType.NUMBER_OF_FILTERS' in label:
            return HyperParameterType.NUMBER_OF_FILTERS
        elif 'HyperParameterType.FILTER_HEIGHT' in label:
            return HyperParameterType.FILTER_HEIGHT
        elif 'HyperParameterType.FILTER_WIDTH' in label:
            return HyperParameterType.FILTER_WIDTH
        else:
            return None
